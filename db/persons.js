...
persons_db['list'] = [
...

  {
    ...
    name: 'Деникин<br> Антон Иванович',
    desc: 'Генерал-майор, командир 4-й стрелковой бригады, прозванной за мужество «железной»',
    years: '1914 - 1956',
    ordens: [

      {
        _orden_id: 1,
        sucess: 'Орден совпал!<br> Ты молодец и очень красивый человек, продолжай в том же духе...',
        reject: false
      },
